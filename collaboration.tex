...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item {Milestone 1.3 (Thrust 2.1: Correction System):} Design, build, and align the low-risk 3-plane multi-conjugate correction system. Validate its performance by correcting pre-defined, known aberrations.
	...
	\begin{itemize}
		...
		\item {Milestone 2.2 (Multi-Conjugate Correction Demonstration):} Integrate the 3D aberration model (from M1.1) with the low-risk 3-plane multi-conjugate correction system (from M1.3). Demonstrate medium field-of-view imaging, which will significantly reduce the required scanning range, on fixed biological samples.
		
		\item {Milestone 2.3 (Thrust 2.2):} Begin high-risk relayed-MPLC system. Finalize the design, fabricate components, and begin assembly of the high-risk, high-gain single-SLM {relayed-MPLC} system.
		
		\item {Milestone 2.4 (Dissemination):} Release the initial open-source software package for diffraction tomography and wavefront shaping corrections.
	\end{itemize}
